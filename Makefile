...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Wed May 19 20:03:37 2010
...
SOURCES       = main.cpp \
		qtincoming.cpp \
		incomingmailmodel.cpp moc_qtincoming.cpp \
		moc_incomingmailmodel.cpp
OBJECTS       = main.o \
		qtincoming.o \
		incomingmailmodel.o \
		moc_qtincoming.o \
		moc_incomingmailmodel.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qmailcheck1.0.0/ && $(COPY_FILE) --parents qtincoming.h incomingmailmodel.h .tmp/qmailcheck1.0.0/ && $(COPY_FILE) --parents main.cpp qtincoming.cpp incomingmailmodel.cpp .tmp/qmailcheck1.0.0/ && $(COPY_FILE) --parents qtincoming.ui .tmp/qmailcheck1.0.0/ && (cd `dirname .tmp/qmailcheck1.0.0` && $(TAR) qmailcheck1.0.0.tar qmailcheck1.0.0 && $(COMPRESS) qmailcheck1.0.0.tar) && $(MOVE) `dirname .tmp/qmailcheck1.0.0`/qmailcheck1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qmailcheck1.0.0
...
moc_incomingmailmodel.cpp: incomingmailmodel.h
...
moc_qtincoming.o: moc_qtincoming.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_qtincoming.o moc_qtincoming.cpp

moc_incomingmailmodel.o: moc_incomingmailmodel.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_incomingmailmodel.o moc_incomingmailmodel.cpp
