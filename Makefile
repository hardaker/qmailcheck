...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon May 24 16:19:37 2010
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qmailcheck1.0.0/ && $(COPY_FILE) --parents qtincoming.h incomingmailmodel.h mailmsg.h .tmp/qmailcheck1.0.0/ && $(COPY_FILE) --parents main.cpp qtincoming.cpp incomingmailmodel.cpp mailmsg.cpp .tmp/qmailcheck1.0.0/ && $(COPY_FILE) --parents qtincoming.ui prefs.ui .tmp/qmailcheck1.0.0/ && (cd `dirname .tmp/qmailcheck1.0.0` && $(TAR) qmailcheck1.0.0.tar qmailcheck1.0.0 && $(COMPRESS) qmailcheck1.0.0.tar) && $(MOVE) `dirname .tmp/qmailcheck1.0.0`/qmailcheck1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qmailcheck1.0.0
